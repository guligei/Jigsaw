...
- (CGPoint)getPositionFor:(id)point toast:(UIView *)toast {
    ...
    if([point isKindOfClass:[NSString class]]) {
        ...
        if( [point caseInsensitiveCompare:@"top"] == NSOrderedSame ) {
            ...
            return CGPointMake(self.bounds.size.width/2, self.bounds.size.height*0.8f);
...
- (UIView *)makeViewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        NSDictionary *dict = @{NSFontAttributeName:[UIFont boldSystemFontOfSize:kFontSize]};
        CGSize expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
    ...
    if (message != nil) {
        ...
        NSDictionary *dict = @{NSFontAttributeName:[UIFont systemFontOfSize:kFontSize]};
        CGSize expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil].size;
